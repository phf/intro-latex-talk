...
% some basic meta information
\title{A Simple Article on Some Topic}
% note how I put the umlaut in there
\author{Peter H.\ Fr{\"o}hlich}

\begin{document}

% render the \title and \author from above
\maketitle

% format the abstract appropriately
\begin{abstract}
...
% switch section numbering for appendices
\appendix
